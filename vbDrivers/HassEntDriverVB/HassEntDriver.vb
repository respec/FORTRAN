Module HassEntDriver

    Declare Function F90_WDMOPN Lib "hass_ent.dll" _
        (ByRef aWdmsFile As Integer, ByVal aSourceFile As String, ByVal aSourceFileNameLength As Short) As Integer

    Declare Function F90_WDMCLO Lib "hass_ent.dll" _
        (ByRef aWdmsFile As Integer) As Integer

    Declare Function F90_WDBOPN Lib "hass_ent.dll" _
        (ByRef aFileUnit As Integer, ByVal aSourceFile As String, ByVal aSourceFileNameLength As Short) As Integer

    Declare Function F90_WDCKDT Lib "hass_ent.dll" _
        (ByRef aWdmsFile As Integer, ByRef aDSN As Integer) As Integer

    Declare Function F90_WDFLCL Lib "hass_ent.dll" _
        (ByRef aWdmsFile As Integer) As Integer

    Declare Sub F90_WDDSNX Lib "hass_ent.dll" _
        (ByRef aWdmsFile As Integer, ByRef aDsn As Integer)

    Declare Sub F90_WTFNDT Lib "hass_ent.dll" _
        (ByRef aWdmsFile As Integer, ByRef aDsn As Integer, ByRef aGpflg As Integer, ByRef aTdsfrc As Integer, ByVal aSDate() As Integer, ByVal aEDate() As Integer, ByRef aRetcod As Integer)

    Declare Sub F90_WDTGET Lib "hass_ent.dll" _
        (ByRef aWdmsFile As Integer, ByRef aDsn As Integer, ByRef aDelt As Integer, ByVal aDates() As Integer,
    ...
    Declare Sub F90_WDBSGI Lib "hass_ent.dll" _
        (ByRef aWdmsFile As Integer, ByRef aDsn As Integer, ByRef aSaind As Integer, ByRef aSalen As Integer,
                          ByRef aSaval As Integer, ByRef aRetcod As Integer)

    Declare Sub F90_WDBSAI Lib "hass_ent.dll" _
        (ByRef aWdmsFile As Integer, ByRef aDsn As Integer, ByRef aMsFile As Integer, ByRef aSaind As Integer, ByRef aSalen As Integer,
                          ByRef aSaval As Integer, ByRef aRetcod As Integer)
    ...
    Declare Sub F90_WDBSGC Lib "hass_ent.dll" _
        (ByRef aWdmsFile As Integer, ByRef aDsn As Integer, ByRef aSaind As Integer, ByRef aSalen As Integer,
                          ByVal aSaval() As Integer)

    Declare Sub F90_WDBSGCX Lib "hass_ent.dll" _
        (ByRef aWdmsFile As Integer, ByRef aDsn As Integer, ByRef aSaind As Integer, ByRef aSalen As Integer,
    ...
    Sub Main()
        ...
        Debug.Print("Start HassEntDriverFortran")
        ...
        Debug.Print("End HassEntDriverFortran")
