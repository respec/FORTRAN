...
integer, parameter :: NWS_TAPE = 2 
integer, parameter :: NWS_SPACE_DELIMITED = 3
integer, parameter :: NWS_COMMA_DELIMITED = 4
integer, parameter :: AES_HLY = 4
integer, parameter :: CMC_HLY = 5
integer, parameter :: CMC_FIF = 6
integer, parameter :: STD_SPACE_DELIMITED = 7

!enum ConditionCodes {
integer, parameter :: NO_CONDITION = 1
integer, parameter :: ACCUMULATED_PERIOD = 2
integer, parameter :: DELETED_PERIOD = 3
integer, parameter :: MISSING_PERIOD = 4

!-----------------------------------------------------------------------------
!  Shared variables
!-----------------------------------------------------------------------------
type(TRainStats) RainStats                  ! see objects.h for definition
integer ::        Condition                  ! rainfall condition code
