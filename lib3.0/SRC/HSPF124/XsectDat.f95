...
real(kind=dp), dimension(51), parameter :: xs_A_Circ = &    ! A/Afull v. Y/Yfull
...
real(kind=dp), dimension(51), parameter :: xs_R_Circ = &  ! R/Rfull v. Y/Yfull
...
real(kind=dp), dimension(51), parameter :: xs_Y_Circ = &  ! Y/Yfull v. A/Afull
...
real(kind=dp), dimension(51), parameter :: xs_S_Circ = &  ! S/Sfull v. A/Afull
...
!/***************************************************************************** !5.0.010
!real(kind=dp), dimension(xx), parameter :: S_FM_Circ[51] =  ! S/Sfull v. A/Afull for circular force main          !5.0.010
...
!/***************************************************************************** !5.0.010
!integer ::    N_W_Circ   = 26
!real(kind=dp), dimension(xx), parameter :: W_Circ[26] =    ! W/Wmax v. Y/Yfull
...
real(kind=dp), dimension(51), parameter :: xs_W_Circ = &  ! W/Wmax v. Y/Yfull !5.0.010
...
real(kind=dp), dimension(26), parameter :: xs_A_Egg = &
...
real(kind=dp), dimension(26), parameter :: xs_R_Egg = &
...
real(kind=dp), dimension(51), parameter :: xs_Y_Egg =  &
...
real(kind=dp), dimension(51), parameter :: xs_S_Egg =  &
...
real(kind=dp), dimension(26), parameter :: xs_W_Egg = &
...
real(kind=dp), dimension(26), parameter :: xs_A_Horseshoe = &
...
real(kind=dp), dimension(26), parameter :: xs_R_Horseshoe = &
...
real(kind=dp), dimension(51), parameter :: xs_Y_Horseshoe = &
...
real(kind=dp), dimension(51), parameter :: xs_S_Horseshoe = &
...
real(kind=dp), dimension(26), parameter :: xs_W_Horseshoe = &
...
real(kind=dp), dimension(51), parameter :: xs_Y_Gothic = &
...
real(kind=dp), dimension(51), parameter :: xs_S_Gothic = &
...
real(kind=dp), dimension(21), parameter :: xs_W_Gothic = &
...
real(kind=dp), dimension(51), parameter :: xs_Y_Catenary = &
...
real(kind=dp), dimension(51), parameter :: xs_S_Catenary = &
...
real(kind=dp), dimension(21), parameter :: xs_W_Catenary = &
...
real(kind=dp), dimension(51), parameter :: xs_Y_SemiEllip = &
...
real(kind=dp), dimension(51), parameter :: xs_S_SemiEllip = &
...
real(kind=dp), dimension(21), parameter :: xs_W_SemiEllip = &
...
real(kind=dp), dimension(26), parameter :: xs_A_Baskethandle = &
...
real(kind=dp), dimension(26), parameter :: xs_R_Baskethandle = &
...
real(kind=dp), dimension(51), parameter :: xs_Y_BasketHandle = &
...
real(kind=dp), dimension(51), parameter :: xs_S_BasketHandle = &
...
real(kind=dp), dimension(26), parameter :: xs_W_BasketHandle = &
...
real(kind=dp), dimension(51), parameter :: xs_Y_SemiCirc = &
...
real(kind=dp), dimension(51), parameter :: xs_S_SemiCirc = &
...
real(kind=dp), dimension(21), parameter :: xs_W_SemiCirc = &
...
!  Minor  axis (inches)
real(kind=dp), dimension(23), parameter :: xs_MinorAxis_Ellipse = &
&(/ 14,19,22,24,27,29,32,34,38,43,48,53,58,63,68,72,77,82,87,92,97,106,116/)

!  Major axis (inches)
real(kind=dp), dimension(23), parameter :: xs_MajorAxis_Ellipse = &
&(/ 23,30,34,38,42,45,49,53,60,68,76,83,91,98,106,113, 121,128,136,143,151, &
 &166,180/)

!  Full area (sq.ft.)
real(kind=dp), dimension(23), parameter :: xs_Afull_Ellipse = &
...
real(kind=dp), dimension(23), parameter :: xs_Rfull_Ellipse = &
...
real(kind=dp), dimension(26), parameter :: xs_A_HorizEllipse = &
...
real(kind=dp), dimension(26), parameter :: xs_R_HorizEllipse = &
...
real(kind=dp), dimension(26), parameter :: xs_W_HorizEllipse = &
& (/ .0,.3919,.5426,.6499,.7332,.8000,.8542,.8980,.9330,.9600, &
 &.9798,.9928,.9992,.9992,.9928,.9798,.9600,.9330,.8980,.8542, &
 &.8000,.7332,.6499,.5426,.3919,.0/)
...
real(kind=dp), dimension(26), parameter :: xs_A_VertEllipse = &
...
real(kind=dp), dimension(26), parameter :: xs_R_VertEllipse = &
...
real(kind=dp), dimension(26), parameter :: xs_W_VertEllipse = &
 &(/ .0,.3919,.5426,.6499,.7332,.8000,.8542,.8980,.9330,.9600, &
 &.9798,.9928,.9992,.9992,.9928,.9798,.9600,.9330,.8980,.8542, &
 &.8000,.7332,.6499,.5426,.3919,.0/)
...
real(kind=dp), dimension(102), parameter :: xs_Yfull_Arch = &   ! NOTE: these are in inches
...
real(kind=dp), dimension(102), parameter :: xs_Wmax_Arch = &    ! NOTE: these are in inches
...
real(kind=dp), dimension(102), parameter :: xs_Afull_Arch = &
...
real(kind=dp), dimension(102), parameter :: xs_Rfull_Arch = &
...
real(kind=dp), dimension(26), parameter :: xs_A_Arch = &
...
real(kind=dp), dimension(26), parameter :: xs_R_Arch = &
...
real(kind=dp), dimension(26), parameter :: xs_W_Arch = &
