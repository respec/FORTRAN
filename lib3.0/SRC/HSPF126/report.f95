...
character(51), parameter :: LINE_51 = &
&'---------------------------------------------------'
character(61), parameter :: LINE_61 = &
&'-------------------------------------------------------------'
...
!    if ( Frpt.file ) then
!        WRITE(*,*) ''
!        fprintf(Frpt.file, error_getMsg(errCode), s)
!    end if
    ErrorCode = errCode
end subroutine report_writeErrorMsg
!
!!=============================================================================
!
...
!!
    implicit none
    character(*), intent(in) :: msg, id
!    !fprintf(Frpt.file, "\n\n  %s %s", msg, id)                           !(5.0.022 - LR)
!    write(Frpt%fileHandle, *) msg, '   ', id
end subroutine report_writeWarningMsg
!
!
!!! --- New function added for release 5.0.014 --- !!                        !(5.0.014 - LR)
!
