...
subroutine flowrout_init(int routingModel)
!
...
subroutine flowrout_close(int routingModel)
!
...
double precision function flowrout_getRoutingStep(int routingModel, double fixedStep)
!
...
integer function flowrout_execute(int links[], int routingModel, double tStep)
!
...
subroutine initNodeDepths(void)
!
!  Input:   none
!  Output:  none
...
double precision function getStorageOutflow(int i, int j, int links[], double dt)
!
!  Input:   i = index of storage node
!           j = current position in links array
!           links = array of topo-sorted link indexes
...
subroutine updateNodeDepth(int i, double y)
!
!  Input:   i = node index
!           y = flow depth (ft)
!  Output:  none
...
!integer function steadyflow_execute(int j, double* qin, double* qout)
!!
!!  Input:   j = link index
