...
integer, parameter :: N_A_Circ = 51
double precision, dimension(51), parameter :: xs_A_Circ = &    ! A/Afull v. Y/Yfull
...
integer, parameter :: N_R_Circ = 51
double precision, dimension(51), parameter :: xs_R_Circ = &  ! R/Rfull v. Y/Yfull
...
integer, parameter :: N_Y_Circ = 51
double precision, dimension(51), parameter :: xs_Y_Circ = &  ! Y/Yfull v. A/Afull
...
integer, parameter :: N_S_Circ = 51
double precision, dimension(51), parameter :: xs_S_Circ = &  ! S/Sfull v. A/Afull
...
!/***************************************************************************** !5.0.010
!double precision, dimension(xx), parameter :: S_FM_Circ[51] =  ! S/Sfull v. A/Afull for circular force main          !5.0.010
!(/0.0, 0.00569, 0.01515, 0.02682, 0.04017, 0.05492, 0.07086, 0.08786, 0.10580,  !5.0.010
!      0.12459, 0.14415, 0.16444, 0.18538, 0.20693, 0.22905, 0.25169, 0.27483,  !5.0.010
!      0.29842, 0.32243, 0.34684, 0.37161, 0.39672, 0.42214, 0.44785, 0.47381,  !5.0.010
!      0.50000, 0.52640, 0.55298, 0.57970, 0.60656, 0.63350, 0.66052, 0.68756,  !5.0.010
!      0.71460, 0.74159, 0.76851, 0.79529, 0.82189, 0.84824, 0.87428, 0.89991,  !5.0.010
!      0.92505, 0.94954, 0.97323, 0.99588, 1.01717, 1.03661, 1.05335, 1.06577,  !5.0.010
!      1.06949, 1.00000/)                                                       !5.0.010
!******************************************************************************!/5.0.010

!/***************************************************************************** !5.0.010
!integer ::    N_W_Circ   = 26
!double precision, dimension(xx), parameter :: W_Circ[26] =    ! W/Wmax v. Y/Yfull
...
!*****************************************************************************
integer, parameter :: N_W_Circ = 51     !5.0.010
double precision, dimension(51), parameter :: xs_W_Circ = &  ! W/Wmax v. Y/Yfull !5.0.010
       &(/0.0,   .2800,   .3919,   .4750,   .5426,   .6000,   .6499,   .6940,   .7332, &!5.0.010
       &.7684,   .8000,   .8285,   .8542,   .8773,   .8980,   .9165,   .9330, &!5.0.010
       &.9474,   .9600,   .9708,   .9798,   .9871,   .9928,   .9968,   .9992, &!5.0.010
       &1.000,   .9992,   .9968,   .9928,   .9871,   .9798,   .9708,   .9600, &!5.0.010
       &.9474,   .9330,   .9165,   .8980,   .8773,   .8542,   .8285,   .8000, &!5.0.010
       &.7684,   .7332,   .6940,   .6499,   .6000,   .5426,   .4750,   .3919, &!5.0.010
       &.2800,   .0/)                                                          !5.0.010
!******************************************************************************!/5.0.010
...
integer, parameter :: N_A_Egg = 26
double precision, dimension(26), parameter :: xs_A_Egg = &
...
integer, parameter :: N_R_Egg = 26
double precision, dimension(26), parameter :: xs_R_Egg = &
...
integer, parameter :: N_Y_Egg = 51
double precision, dimension(51), parameter :: xs_Y_Egg =  &
...
integer, parameter :: N_S_Egg = 51
double precision, dimension(51), parameter :: xs_S_Egg =  &
...
integer, parameter :: N_W_Egg = 26
double precision, dimension(26), parameter :: xs_W_Egg = &
...
integer, parameter :: N_A_Horseshoe = 26
double precision, dimension(26), parameter :: xs_A_Horseshoe = &
...
integer, parameter :: N_R_Horseshoe = 26
double precision, dimension(26), parameter :: xs_R_Horseshoe = &
...
integer, parameter :: N_Y_Horseshoe = 51
double precision, dimension(51), parameter :: xs_Y_Horseshoe = &
...
integer, parameter :: N_S_Horseshoe = 51
double precision, dimension(51), parameter :: xs_S_Horseshoe = &
...
integer, parameter :: N_W_Horseshoe = 26
double precision, dimension(26), parameter :: xs_W_Horseshoe = &
...
integer, parameter :: N_Y_Gothic = 51
double precision, dimension(51), parameter :: xs_Y_Gothic = &
...
integer, parameter :: N_S_Gothic = 51
double precision, dimension(51), parameter :: xs_S_Gothic = &
...
integer, parameter :: N_W_Gothic = 21
double precision, dimension(21), parameter :: xs_W_Gothic = &
...
integer, parameter :: N_Y_Catenary = 51
double precision, dimension(51), parameter :: xs_Y_Catenary = &
...
integer, parameter :: N_S_Catenary = 51
double precision, dimension(51), parameter :: xs_S_Catenary = &
...
integer, parameter :: N_W_Catenary = 21
double precision, dimension(21), parameter :: xs_W_Catenary = &
...
integer, parameter :: N_Y_SemiEllip = 51
double precision, dimension(51), parameter :: xs_Y_SemiEllip = &
...
integer, parameter :: N_S_SemiEllip = 51
double precision, dimension(51), parameter :: xs_S_SemiEllip = &
...
integer, parameter :: N_W_SemiEllip = 21
double precision, dimension(21), parameter :: xs_W_SemiEllip = &
...
integer, parameter :: N_A_Baskethandle = 26
double precision, dimension(26), parameter :: xs_A_Baskethandle = &
...
integer, parameter :: N_R_Baskethandle = 26
double precision, dimension(26), parameter :: xs_R_Baskethandle = &
...
integer, parameter :: N_Y_BasketHandle = 51
double precision, dimension(51), parameter :: xs_Y_BasketHandle = &
...
integer, parameter :: N_S_BasketHandle = 51
double precision, dimension(51), parameter :: xs_S_BasketHandle = &
...
integer, parameter :: N_W_BasketHandle = 26
double precision, dimension(26), parameter :: xs_W_BasketHandle = &
...
integer, parameter :: N_Y_SemiCirc = 51
double precision, dimension(51), parameter :: xs_Y_SemiCirc = &
...
integer, parameter :: N_S_SemiCirc = 51
double precision, dimension(51), parameter :: xs_S_SemiCirc = &
...
integer, parameter :: N_W_SemiCirc = 21
double precision, dimension(21), parameter :: xs_W_SemiCirc = &
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!/
!  Standard tables added for Ellipse shapes. (LR - 9/5/05)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!/
...
integer, parameter :: NumCodesEllipse = 23

!  Minor  axis (inches)
double precision, dimension(23), parameter :: xs_MinorAxis_Ellipse = &
&(/ 14,19,22,24,27,29,32,34,38,43,48,53,58,63,68,72,77,82,87,92,97,106,116/)

!  Major axis (inches)
double precision, dimension(23), parameter :: xs_MajorAxis_Ellipse = &
&(/ 23,30,34,38,42,45,49,53,60,68,76,83,91,98,106,113, 121,128,136,143,151, &
 &166,180/)

!  Full area (sq.ft.)
double precision, dimension(23), parameter :: xs_Afull_Ellipse = &
...
double precision, dimension(23), parameter :: xs_Rfull_Ellipse = &
...
integer, parameter :: N_A_HorizEllipse = 26
double precision, dimension(26), parameter :: xs_A_HorizEllipse = &
...
integer, parameter :: N_R_HorizEllipse = 26
double precision, dimension(26), parameter :: xs_R_HorizEllipse = &
...
integer, parameter :: N_W_HorizEllipse = 26
double precision, dimension(26), parameter :: xs_W_HorizEllipse = &
& (/ .0,.3919,.5426,.6499,.7332,.8000,.8542,.8980,.9330,.9600, &
 &.9798,.9928,.9992,.9992,.9928,.9798,.9600,.9330,.8980,.8542, &
 &.8000,.7332,.6499,.5426,.3919,.0/)
...
integer, parameter :: N_A_VertEllipse   = 26
double precision, dimension(26), parameter :: xs_A_VertEllipse = &
...
integer, parameter :: N_R_VertEllipse = 26
double precision, dimension(26), parameter :: xs_R_VertEllipse = &
&(/ .0100,.1250,.2436,.3536,.4474,.5484,.6366,.7155,.7768,.8396, &
 ...
 integer, parameter ::    N_W_VertEllipse   = 26
double precision, dimension(26), parameter :: xs_W_VertEllipse = &
 &(/ .0,.3919,.5426,.6499,.7332,.8000,.8542,.8980,.9330,.9600, &
 &.9798,.9928,.9992,.9992,.9928,.9798,.9600,.9330,.8980,.8542, &
 &.8000,.7332,.6499,.5426,.3919,.0/)
...
!=============================================================================
 ...
 integer, parameter :: NumCodesArch = 102

double precision, dimension(102), parameter :: xs_Yfull_Arch = &   ! NOTE: these are in inches
 &(/ 11.0,13.5,15.5,18.0,22.5,26.625,31.3125,36.0,40.0,45.0,54.0,62.0, &
    &72.0,77.5,87.125,96.875,106.5,13.0,15.0,18.0,20.0,24.0,29.0,33.0,38.0,43.0,47.0,52.0,57.0, &
    &31.0,31.0,41.0,46.0,51.0,55.0,59.0,63.0,67.0,71.0,75.0,79.0,83.0,87.0,91.0,55.0,57.0,59.0,61.0,63.0,65.0, &
    &67.0,69.0,71.0,73.0,75.0,77.0,79.0,81.0,83.0,85.0,87.0,89.0,91.0,93.0,95.0,97.0,100.0,101.0,103.0,105.0, &
    &107.0,109.0,111.0,113.0,115.0,118.0,119.0,121.0,112.0,114.0,116.0,118.0,120.0,122.0,124.0,126.0, &
    &128.0,130.0,132.0,134.0,136.0,138.0,140.0,142.0,144.0,146.0,148.0,150.0,152.0,154.0,156.0,158.0/)

double precision, dimension(102), parameter :: xs_Wmax_Arch = &    ! NOTE: these are in inches
  &(/ 18.0,22.0,26.0,28.5,36.25,43.75,51.125,58.5,65.0,73.0,88.0,102.0, &
    &115.0,122.0,138.0,154.0,168.75,17.0,21.0,24.0,28.0,35.0,42.0,49.0,57.0,64.0,71.0,77.0,83.0,40.0, &
    &46.0,53.0,60.0,66.0,73.0,81.0,87.0,95.0,103.0,112.0,117.0,128.0,137.0,142.0,73.0,76.0,81.0,84.0,87.0, &
    &92.0,95.0,98.0,103.0,106.0,112.0,114.0,117.0,123.0,128.0,131.0,137.0,139.0,142.0,148.0,150.0,152.0, &
    &154.0,161.0,167.0,169.0,171.0,178.0,184.0,186.0,188.0,190.0,197.0,199.0,159.0,162.0,168.0,170.0, &
    &173.0,179.0,184.0,187.0,190.0,195.0,198.0,204.0,206.0,209.0,215.0,217.0,223.0,225.0,231.0,234.0, &
    &236.0,239.0,245.0,247.0/)

double precision, dimension(102), parameter :: xs_Afull_Arch = &
  &(/ 1.1,1.65,2.2,2.8,4.4,6.4,8.8,11.4,14.3,17.7,25.6,34.6, &
    &44.5,51.7,66.0,81.8,99.1,1.1,1.6,2.2,2.9,4.5,6.5,8.9,11.6,14.7,18.1, &
    &21.9,26.0,7.0,9.4,12.3,15.6,19.3,23.2,27.4,32.1,37.0,42.4,48.0,54.2,60.5, &
    &67.4,74.5,22.0,24.0,26.0,28.0,31.0,33.0,35.0,38.0,40.0,43.0,46.0,49.0,52.0,55.0,58.0,61.0,64.0,67.0, &
    &71.0,74.0,78.0,81.0,85.0,89.0,93.0,97.0,101.0,105.0,109.0,113.0,118.0,122.0,126.0,131.0,97.0,102.0, &
    &105.0,109.0,114.0,118.0,123.0,127.0,132.0,137.0,142.0,146.0,151.0,157.0,161.0,167.0,172.0,177.0, &
    &182.0,188.0,194.0,200.0,205.0,211.0/)

double precision, dimension(102), parameter :: xs_Rfull_Arch = &
 ...
 integer, parameter ::    N_A_Arch   = 26
double precision, dimension(26), parameter :: xs_A_Arch = &
&(/ .0000,.0200,.0600,.1000,.1400,.1900,.2400,.2900,.3400,.3900, &
 ...
 integer, parameter ::    N_R_Arch   = 26
double precision, dimension(26), parameter :: xs_R_Arch = &
&(/ .0100,.0983,.1965,.2948,.3940,.4962,.5911,.6796,.7615,.8364, &
 ...
 integer, parameter ::    N_W_Arch   = 26
double precision, dimension(26), parameter :: xs_W_Arch = &
