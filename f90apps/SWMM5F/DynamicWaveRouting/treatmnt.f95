...
!enum   ProcessVarType {
integer(kind=K2), parameter :: pvHRT = 1   ! hydraulic residence time
integer(kind=K2), parameter :: pvDT = 2    ! time step duration
integer(kind=K2), parameter :: pvFLOW = 3  ! flow rate
integer(kind=K2), parameter :: pvDEPTH = 4 ! water height above invert
integer(kind=K2), parameter :: pvAREA = 5  ! storage surface area
!}
