...
!!=============================================================================
!
real(kind=dp) function table_interpolate(x, x1, y1, x2, y2)
!
...
!
    implicit none
    real(kind=dp), intent(in) :: x, x1, y1, x2, y2
    real(kind=dp) :: dx
    dx = x2 - x1
...
!!=============================================================================
!
real(kind=dp) function table_tseriesLookup1(tablex, tabley, nItems, x, extend)
!
!  Input:   table = pointer to a TTable structure
!           x = a date/time value
!           extend = TRUE if time series extended on either end
...
! my own version just for testing DW routing
    ...
    real(kind=dp), dimension(:), intent(inout) :: tablex, tabley
    ...
    table_tseriesLookup1 = lyVal 
end function table_tseriesLookup1
!
!!=============================================================================
!
