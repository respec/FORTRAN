...
C=======================================================================
 2900 IF(NGWGF.EQ.0) GO TO 3900
      ...
      TOTFLW(J,K) = 0.0
 3100 TOTDEV(J,K) = 0.0
      IF(JCE.EQ.0) WRITE(N6,2530) (NAMEW(J),NGWTOG(J),J=IG,KOT)
      IF(JCE.EQ.1) WRITE(N6,2531) (KAMEW(J),KGWTOG(J),J=IG,KOT)
 ...
 3300 TOTDEV(3,KK) = TOTDEV(3,KK) + DELT*GWFLWA(K)**2
     ...
     +                             (NAMEW(J),NGWTOG(J),J=IG,KOT)
                      IF(JCE.EQ.1) WRITE(N6,2531)
     +                             (KAMEW(J),KGWTOG(J),J=IG,KOT)
                      WRITE(N6,2540) (BMJ,J=IG,KOT)
                      IF(METRIC.EQ.1) WRITE(N6,2550) (BMJ,J=IG,KOT)
                      IF(METRIC.EQ.2) WRITE(N6,2555) (BMJ,J=IG,KOT)
                      WRITE(N6,2560) (BMJ,J=IG,KOT)
...
C#### WCH, 12/5/94.  CHANGE FROM 5X,I7 TO 3X,I9.
 ...
 2550 FORMAT(2X,'Mo/Da/Year   Hr:Min',
     .         3(A3,'   Feet  Moisture        cfs'))
 2555 FORMAT(2X,'Mo/Da/Year   Hr:Min',
     .         3(A3,'   Feet  Moisture      cum/s'))
 2560 FORMAT(2X,'--------   ------',
     +         3(A3,'   ----  --------      -----'))
 2570 FORMAT(2X,2(I2,'/'),I4,3X,I2,I4,3(2F10.3,F11.3))
 ...
 2586 FORMAT(22X,3(A3,16X,'  Cubic-feet'))
 2587 FORMAT(22X,3(A3,16X,'Cubic-meters'))
 4030 FORMAT(1H1,/,
     1' ################################################',/,
