     ...
     1           TR,DELT,TIME,RI,RLOSS,UL,SVAP,KAMEW,NAMEW)
C     RUNOFF BLOCK
...
C=======================================================================
      INCLUDE 'TAPES.INC'
      DOUBLE PRECISION RI,RLOSS,SVAP
      CHARACTER KAMEW*10
C=======================================================================
...
C=======================================================================
      IF(R1.LE.HYDCON) THEN
                       ...
                       ENDIF
C=======================================================================
C     Rain intensity > Hyd. conductivity.
C=======================================================================
      TR = 900.0*TBS/UL
...
C=======================================================================
  210 IF((F2-F).LE.(WDEPTH+RVOL)) THEN
