...
C#### WCH, 11/29/93.
  100 FORMAT(/,
     ...
     1' *                                                       *',/,
     1' * Most recent update: March 1999 by CDM, Oregon         *',/,
     1' * State University, and XP Software, Inc.               *')
  101 FORMAT(
     1' *********************************************************',/)
  102 FORMAT(
     1' *                                                       *',/,
     ...
     1' *********************************************************',/)
  103 FORMAT(5X,'JIN WAS SET TO NONZERO BUT FILE NAME WAS NOT',
     a' SPECIFIED THROUGH @ LINES',/,5X,'JIN IS SET TO ZERO')
  104	FORMAT(5X,'JOUT WAS SET TO NONZERO BUT FILE NAME WAS NOT ',
