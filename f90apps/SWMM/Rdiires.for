...
C=======================================================================
      IF(METRIC.EQ.2) THEN
           DSTORE(J,I,JJ)  = DSTORE(J,I,JJ)/25.4
           STORAGE(J,I,JJ) = STORAGE(J,I,JJ)/25.4
           DREC(J,I,JJ)    = DREC(J,I,JJ)/25.4
           ENDIF
   50 CONTINUE
C=======================================================================
...
C=======================================================================
     ...
     1                                    (BAIN(J),J=1,NSTA)
      ...
      JDAY = JDAY + JYEAR*1000
      ENDIF
c  change to have a tolerance of .5 minutes
