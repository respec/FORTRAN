...
C  initialization.  Further uptdated to include element type 27
C=======================================================================
...
C     TYPE=27   QUALITY FLOW SPLIT                             KLASS = 3
C=======================================================================
      INCLUDE 'NAMES.INC'      
	COMMON/TABLES/KDEPTH(27),KLASS(27),PSIMAX(18),ALFMAX(18),
     1              NN(27),MM(27),ANORM(18,51),QN1(144),QN2(144),
...
C=======================================================================
     ...
     *          'TAB FLOW DIVIDER','QUALITY DIVIDER '/
      DATA GNO/'NO  '/, YES/'YES '/
      DATA KDEPTH/2,1,7*2,4*1,5*2,9*3/
      DATA KLASS/2,1,7*2,4*1,5*2,9*3/
      DATA NN/51,1,7*51,9*1,9*0/
      DATA MM/51,1,7*51,9*1,9*0/
