 ...
 99     CONTINUE
      ...
      !local
      INTEGER FUNCTION INQUIRE_NAME(NAME,FUN)
        CHARACTER*64       :: NAME
        INTEGER            :: FUN
...
99      CONTINUE
 ...
 99     CONTINUE
      ...
      SUBROUTINE F90_WDBOPNR(RWFLG,WDNAME,WDMSFL,RETCOD)
        ...
        WRITE(MSG,*) 'HASS_ENT:F90_WDBOPNR:entr:RWFLG,WDMSFL:',RWFLG,WDMSFL,' ',TRIM(LNAME)
        CALL LOG_MSG(MSG)
      ...
      FUNCTION F90_WDFLCL(WDMSFL) RESULT (RETCOD)
        ...
        IF (OPEN) THEN
          ...
          WRITE(MSG,*) 'HASS_ENT:F90_WDFLCL:close:RETCOD:',RETCOD
          CALL LOG_MSG(MSG)
        ELSE
      ...
      FUNCTION F90_INQNAM (NAM)
        ...
        F90_INQNAM = INQUIRE_NAME(LNAM, FUN)
