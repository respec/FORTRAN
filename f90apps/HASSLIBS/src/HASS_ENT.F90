...
!2000  FORMAT("ERROR" , I2 , ".FIL")
 ...
 99     CONTINUE
      ...
      FUNCTION F90_WDBOPN(RWFLG,WDNAME) RESULT(WDMSFL) 
        ...
        !WRITE(*,*) 'HASS_ENT:F90_WDBOPN:RETCOD,LNAME',RETCOD,LNAME
        IF (RETCOD .NE. 0) THEN
      ...
      !adwdm:wdopxx
      FUNCTION F90_WDBOPNR(RWFLG,WDNAME,WDMSFL,RETCOD)
        ...
        LNAME = WDNAME
        CALL GET_WDM_FUN(WDMSFL)
        !WRITE(*,*) 'HASS_ENT:F90_WDBOPNR:RWFLG,WDMSFL:',RWFLG,WDMSFL
        CALL WDBOPN(WDMSFL,LNAME,RWFLG,RETCOD)
        !WRITE(*,*) 'HASS_ENT:F90_WDBOPNR:',RWFLG,RETCOD
        IF (RETCOD .NE. 0) THEN
          IF (RETCOD .LT. -10) THEN
            RETCOD = ABS(RETCOD) - 16384
          END IF
