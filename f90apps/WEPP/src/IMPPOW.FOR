      subroutine imppow(ndata,x,y,a)
c
c     + + + PURPOSE + + +
c
c     SR IMPPOW is an impoundment element subroutine used to
c     develop power function fit coefficients.  It is based
c     upon the "Numerical Recipes in Fortran" SR SVDFIT.
c
