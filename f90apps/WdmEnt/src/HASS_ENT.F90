      ...
      SUBROUTINE F90_W99OPN()
        ...
        OPEN(99,FILE='ERROR.FIL') !,ACTION='DENYNONE')
        CALL GET_WDM_FUN(-1)
      ...
      SUBROUTINE F90_TSDRRE (WDMSFL,DATOPT,DOSTUS)
        ...
        CALL TSDRRE (WDMSFL,DATOPT,DOSTUS)
 ...
 20     CONTINUE
      ...
      !iowdm:watinp
      SUBROUTINE F90_WATHED_XX (MESSFL,IVAL,RVAL,ISIT,ITYP,ID,INAME)
      ...
      !iowdm:watinp
      SUBROUTINE F90_WATINP (MESSFL,WDMSFL,RETCOD,IVAL,RVAL,CSCEN,CLOC,CCONS, &
                             ID,NAME,SITE,TYPE)

        !DEC$ ATTRIBUTES DLLEXPORT :: F90_WATINP

        INTEGER, INTENT(IN)          :: MESSFL,WDMSFL,IVAL(6)
