*  $Header: /nwiscvs/watstore/geod/src/vertcon_lib/vrcard.f,v 1.1 1998/07/07 20:10:41 grogers Exp $
*  vrcard.f
*
      REAL FUNCTION vRCARD (CHLINE, LENG, IERR)
*
*  Purpose: Read a real number from a line of card image.
*********************************************************
*
*  $Log: vrcard.f,v $
*  Revision 1.1  1998/07/07 20:10:41  grogers
