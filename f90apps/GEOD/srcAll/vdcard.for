*  $Header: /nwiscvs/watstore/geod/src/vertcon_lib/vdcard.f,v 1.1 1998/07/07 20:10:31 grogers Exp $
*  vdcard.F
*
      DOUBLE PRECISION FUNCTION vDCARD (CHLINE, LENG, IERR)
*
*  PURPOSE: Read a double precision number from a line of card image.
*********************************************************************
*
*  $Log: vdcard.f,v $
*  Revision 1.1  1998/07/07 20:10:31  grogers
