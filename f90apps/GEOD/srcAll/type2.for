*  $Header: /nwiscvs/watstore/geod/src/nadcon_lib/type2.f,v 1.1 1998/07/07 19:32:40 grogers Exp $
*  type2.f
*
      SUBROUTINE TYPE2 (NAME, IDLA, IMLA, SLA, IDLO, IMLO, SLO,
     +                  XPT, YPT, EOF, NOPT, IFMT)
*
*  Purpose: Read a lat-lon file of type 2 format
************************************************
*
*  $Log: type2.f,v $
*  Revision 1.1  1998/07/07 19:32:40  grogers
