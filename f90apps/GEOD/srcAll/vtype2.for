*  $Header: /nwiscvs/watstore/geod/src/vertcon_lib/vtype2.f,v 1.1 1998/07/07 20:10:44 grogers Exp $
*  vtype2.f
*
      SUBROUTINE vTYPE2 (NAME,IDLA, IMLA, SLA, IDLO, IMLO, SLO,
     +                  XPT, YPT, EOF, NOPT)
*
* Purpose: Read a record from a file of type 2.
***********************************************
*
*  $Log: vtype2.f,v $
*  Revision 1.1  1998/07/07 20:10:44  grogers
...
* (or blanks) in columns 41-80.  Columns 33-39 will contain the corr.
* in the output record and are ignored in the input record.
