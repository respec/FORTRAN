!     Last change:  AA   16 May 102    1:48 pm
...
function Write_Binout(Binname,Nval,Values,NameLen,NameString,Opname,OpID,Section,UnitFlag,PrintLevel,CurDate,OpenFlag)
! ****************************************************************
...
! OpenFlag      0 if first interval, else 1 if first operation this interval, 2 if intermediate operation, 3 if last operation
! 
! ****************************************************************
...
! last modified: 27-Sep-2002
      ...
      INTEGER       Nval,NameLen(Nval),OpID,UnitFlag,PrintLevel,CurDate(6),OpenFlag
      REAL          Values(Nval)
 ...
 !    write (99,*) 'WriteBinout:',Opname,':',lOpname,':',Section,':',lSection,':'
 2000 FORMAT (6A1,'  ')
